...
// This integer k gives us the number of times that i fits into N without exceeding N. That is, if i exactly divides N,
// then k will be 1, because only once does i fit into N.

// For example, if N = 10 and i = 3, then N // i is 3, since 3 fits three times in 10. Thus, k will be 3, i.e.
// i can be added three times to the sum.
